...
GITHUB_COMPARE_URL="https://github.com/AxisCommunications/practical-react-components/compare"
GITHUB_COMMIT_URL="https://github.com/AxisCommunications/practical-react-components/commit"
